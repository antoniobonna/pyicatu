...
from api.client import get_cumulative_profitability, get_monthly_profitability, get_tickers
from config import card_container, error_message, info_message, success_message
